...
(function (window) {
    define([
        ...
        var SuggestionItemView = React.createClass({displayName: 'SuggestionItemView',
            clickItem : function (evt) {
                this.props.model.set('selected', true);
            },
            render : function () {
                return (
                    React.DOM.li( {className:'o-search-box-suggestion-item' + (this.props.model.get('selected') ? ' selected' : ''),
        ...
        var SuggestionListView = React.createClass({displayName: 'SuggestionListView',
            render : function () {
                ...
                return (
                    React.DOM.ul( {className:"o-search-box-suggestion",
        ...
        var SearchboxView = React.createClass({displayName: 'SearchboxView',
            ...
            render : function () {
                return (
                    React.DOM.form( {className:"o-search-box w-form-inline", action:"search.html", method:"get", onSubmit:this.submitForm}, 
                        React.DOM.div( {className:"o-search-box-wrap"}, 
                            React.DOM.input(
                            {ref:"searchBoxInput",
                        ...
                        React.DOM.button( {className:"w-btn w-btn-large w-btn-primary"}, "搜索")
                    )
                );
            }
        });
