                    ...
                    return (
                        <li className="o-list-item w-hbox person w-component-card">
                            ...
                            <div className="info-container">
                                ...
                                <p className="works-count w-wc w-text-thirdly">{person.productCount && person.productCount.videos ? person.productCount.videos + Wording.VIDEO_WORKS_WITH_NUMBER : ''}</p>
